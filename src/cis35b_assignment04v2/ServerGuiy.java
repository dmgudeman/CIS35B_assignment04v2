 ...
 * @author davidgudeman
 */
public class ServerGuiy extends javax.swing.JFrame
{
    ...
    public static void main(String args[])
    {
        ...
        {
            java.util.logging.Logger.getLogger(ServerGuiy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
